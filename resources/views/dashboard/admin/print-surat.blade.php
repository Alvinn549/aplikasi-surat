...
<div class="row justify-content-center">
	<div class="col-2">
		@if($profilDesa->logo)
		<img src="{{ asset('storage') }}/{{ $profilDesa->logo }}" class="img img-fluid  mb-2" id="img-preview" alt="" style="height: 50px; width : 50px;">
		@else
		<img src="{{ asset('storage').'/default-logo/email.png' }}" class="img img-fluid  mb-2" id="img-preview" alt="" style="height: 50px; width : 50px;">
		@endif
	</div>
	<div class="col-8">
